...
<?php if(count($messages)) : ?>
	<table border="1" cellspacing="0" cellpadding='3' width='600'>
		...
		<?php $counter = 1 ?>
		<?php foreach ($messages as $key => $list): ?>
			<tr valign='top'>
				...
				<td align='center'><?php echo anchor(site_url()."/admin/messages/view/".$list->id, "view")." | ". 
				anchor(site_url()."/admin/messages/delete/".$list->id, "delete")?></td>
			</tr>
			<?php $counter++ ?>
		<?php endforeach ?>
	</table> 
